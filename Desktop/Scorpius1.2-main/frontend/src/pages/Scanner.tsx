...
import { FeatureGate, UsageGate } from "@/components/subscription/FeatureGate";
...
const Scanner = () => {
  ...
  const [honeypotStats, setHoneypotStats] = useState(() => {
    ...
    return {
      totalDetections: scanStats.totalScans,
      activeThreats: scanStats.threatsDetected,
      successRate:
        scanStats.totalScans > 0
          ? ((scanStats.totalScans - scanStats.threatsDetected) /
              scanStats.totalScans) *
            100
          : 0,
      avgResponseTime: 2.1,
      contractsMonitored: scanStats.contractsAnalyzed,
      dailyBlocks: 0,
    };
  });
  ...
  const handleScanClick = async (type: "quick" | "deep" = "quick") => {
    ...
    try {
      ...
      if (result) {
        ...
        await updateUsage("smartContracts", 1);
        ...
        const scanData = {
          ...
          findings: result.vulnerabilityCount || 0,
        ...
        // Update local stats
        const updatedStats = StorageManager.getScanStats();
        setHoneypotStats((prev) => ({
          ...prev,
          totalDetections: updatedStats.totalScans,
          contractsMonitored: updatedStats.contractsAnalyzed,
        }));
              ...
              >
                <Card className="glass border-cyan-400/20">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    {/* Input Section */}
                    <UsageGate usageType="smartContracts">
                      {scanMode === "address" ? (
