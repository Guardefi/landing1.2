  ...
  const mockBounties = [
    {
      ...
      description: 'Find and report reentrancy vulnerabilities in DeFi protocols',
      reward: 5000,
      difficulty: 'Hard',
    ...
    <>
      ...
      >
          ...
          >
            {[
              ...
              >
                ...
                <div style={{ fontSize: '11px', color: '#999999' }}>{stat.title}</div>
              </div>
            ))}
          </div>
        )}
        ...
        >
          ...
          >
            <div style={{ marginBottom: '16px' }}>
              <Target size={48} style={{ color: '#333333', marginBottom: '12px' }} />
            </div>
            <div
              style={{
                color: '#ffffff',
            ...
            <div style={{ fontSize: '12px', marginTop: '12px', color: '#666666' }}>
        ...
        >
          ...
          >
            <DollarSign size={24} style={{ color: '#00ff88', marginBottom: '12px' }} />
            <div
              style={{
                fontSize: '20px',
                fontWeight: '600',
          ...
          >
            <Shield size={24} style={{ color: '#00ffff', marginBottom: '12px' }} />
            <div
              style={{
                fontSize: '20px',
                fontWeight: '600',
            ...
            <div style={{ fontSize: '12px', color: '#999999' }}>Active Bounties</div>
          </div>
          ...
          >
            <Users size={24} style={{ color: '#ffaa00', marginBottom: '12px' }} />
            <div
              style={{
                fontSize: '20px',
                fontWeight: '600',
            ...
            <div style={{ fontSize: '12px', color: '#999999' }}>Total Submissions</div>
          </div>
        </div>
      </div>
    </>
