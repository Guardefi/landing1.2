  ...
  const [reportTemplates] = useState([
    {
      ...
      description: 'Comprehensive security analysis with vulnerability breakdown',
      category: 'Security',
    ...
    },
    {
      ...
      sections: ['MEV Overview', 'Bot Performance', 'Profit Analysis', 'Market Impact'],
      format: 'Interactive',
    },
    {
      id: 'RPT-003',
          ...
          <div className="flex items-center gap-4 p-2 bg-black/60 rounded-2xl border border-gray-700">
            {[
              ...
              <motion.button
                ...
                style={{
                  boxShadow:
                    activeTab === tab.id ? '0 0 20px rgba(59, 130, 246, 0.3)' : 'none',
                }}
              >
                ...
                >
                      ...
                      <motion.div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${getCategoryColor(
                            template.category,
                          )}20, ${getCategoryColor(template.category)}40)`,
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-orange-400 text-sm">{template.format}</span>
                    </div>
                  </div>
                ...
                {recentReports.map((report, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-white">{report.template}</h3>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {report.status === 'completed' && (
                        <div className="text-right text-sm">
                          ...
                          <p className="text-white font-mono">{report.fileSize}</p>
                        </div>
                      )}
