    ...
    async def check_docker_available(self) -> bool:
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                logger.error(
                    f"Docker is not available: {stderr.decode() if stderr else 'Unknown error'}"
                )
                return False
    ...
    async def pull_image(self, image: str) -> bool:
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                logger.error(
                    f"Failed to pull Docker image {image}: {stderr.decode() if stderr else 'Unknown error'}"
                )
                return False
    ...
    async def stop_container(self, container_id: str) -> bool:
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                logger.error(
                    f"Failed to stop container {container_id}: {stderr.decode() if stderr else 'Unknown error'}"
                )
                return False
    ...
    async def copy_file_to_container(
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                logger.error(
                    f"Failed to copy file to container: {stderr.decode() if stderr else 'Unknown error'}"
                )
                return False
    ...
    async def copy_file_from_container(
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                logger.error(
                    f"Failed to copy file from container: {stderr.decode() if stderr else 'Unknown error'}"
                )
                return False
