...
class APIDocumentation:
    ...
    def generate_markdown(self) -> str:
        ...
        markdown += f"**Version:** {
            self.openapi_schema['info']['version']}\n\n"
        markdown += f"**Description:** {
            self.openapi_schema['info']['description']}\n\n"
    ...
    def generate_html(self) -> str:
        ...
        return get_swagger_ui_html(
            openapi_url="/openapi.json", title=self.app.title + " - API Documentation"
        )
...
def main():
    ...
    parser.add_argument("--title", default="Scorpius Platform API", help="API title")
