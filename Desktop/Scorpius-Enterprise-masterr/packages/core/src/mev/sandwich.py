...
class SandwichStrategy(AbstractStrategy):
    ...
    async def on_tx(self, tx: TransactionData) -> MEVOpportunity | None:
        ...
        try:
            ...
            opportunity = MEVOpportunity(
                ...
                net_profit=Decimal(sandwich_opp.expected_profit - sandwich_opp.gas_cost)
                / Decimal(10**18),
    ...
    async def build_bundle(self, opportunity: MEVOpportunity) -> BundleRequest | None:
        """
    ...
    async def _get_pool_info(self, token0: str, token1: str) -> UniswapV2Pool | None:
        """
