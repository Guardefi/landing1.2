...
from models.mempool_event import (
    MEVOpportunity,
    MEVStrategyType,
    config,
    from,
    ...
    print("\n📋 Next steps:")
    print(
        "1. Set environment variables (INFURA_PROJECT_ID, BOT_WALLET_ADDRESS, BOT_WALLET_PRIVATE_KEY)"
    )
