...
import { useLogin, useBiometricLogin, useSystemStatus } from "@/hooks";
...
const Login = () => {
  ...
  // Get system status for dashboard stats
  ...
  const handleBiometricLogin = () => {
    // In a real app, this would capture biometric data
    biometricLoginMutation.mutate({
      biometric_data: "simulated_fingerprint_data",
      device_id: navigator.userAgent.substring(0, 50), // Simple device ID
    });
  };
  ...
  const systemStats = [
    {
      label: "Active Users",
      value: systemStatus?.current_users?.toString() || "Loading...",
      icon: User,
      color: "text-cyan-400",
    },
    {
      label: "Security Level",
      value: systemStatus?.security_level || "Elite",
      icon: Shield,
      color: "text-green-400",
    },
    {
      label: "Uptime",
      value: systemStatus?.uptime_percentage || "99.97%",
      icon: Zap,
      color: "text-blue-400",
    },
    {
      label: "Global Nodes",
      value: systemStatus?.total_nodes?.toString() || "127",
      icon: Globe,
          ...
          >
            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">
                  ...
                  AI-powered protection for the modern digital landscape.
                </p>
              </motion.div>
            </div>
            ...
            >
              {[
                ...
                { icon: Fingerprint, text: "Advanced Biometric Security" },
              ].map((feature, index) => (
                <motion.div
                  key={feature.text}
              ...
              <CardContent className="space-y-6">
                <AnimatePresence mode="wait">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            id="email"
                            type="email"
                            placeholder="admin@scorpius.com"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="pl-10 pr-10 bg-background/50 border-cyan-500/20 focus:border-cyan-500/50"
                            required
                          />
                          <button
                            type="button"
                  ...
                  {loginMethod === "biometric" && (
                    ...
                    >
                      <div className="space-y-4">
                        <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 flex items-center justify-center">
                  ...
                  {loginMethod === "license" && (
                    ...
                    >
                      <div className="space-y-4">
                        <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-600/20 border border-purple-500/30 flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Access via license verification
                          </p>
                        </div>
                      </div>

                      <Link to="/license-verification">
