...
class HoneypotDetection:
    ...
    # Detection Details
    # "transfer_tax", "gas_grief", "revert_trap", etc.
    honeypot_type: str = "unknown"
    confidence: float = 0.0
...
class ForensicAnalysis:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "incident_start": (
                self.incident_start.isoformat() if self.incident_start else None
            ),
            "incident_end": (
                self.incident_end.isoformat() if self.incident_end else None
            ),
