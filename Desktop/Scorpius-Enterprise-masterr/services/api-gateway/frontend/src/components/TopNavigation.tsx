...
const navigationItems = [
  ...
  },
  {
    ...
    icon: Shield,
    description:
      'Advanced smart contract security analysis (includes Honeypot Detector & Bytecode Matcher)',
    emoji: '🛡️',
    category: 'security',
  },
  {
...

  {
    ...
    href: '/reports',
    icon: FileText,
    description: 'System logs and detailed analysis reports',
    emoji: '📊',
    category: 'reports',
  },
  {
    ...
    href: '/realtime',
    icon: Activity,
    description: 'Live backend data monitoring and analytics',
    emoji: '📡',
    category: 'monitoring',
  },
  {
    ...
    href: '/ai-trading',
    icon: Bot,
    description: 'Intelligent MEV protection and arbitrage opportunities',
    emoji: '🤖',
    category: 'trading',
  },
  {
    ...
    href: '/bridge',
    icon: GitBranch,
    description: 'Seamless multi-chain asset transfers and liquidity management',
    emoji: '🌉',
    category: 'defi',
  },
  {
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 8px 32px rgba(0, 0, 0, 0.9), 0 4px 16px rgba(0, 255, 255, 0.6)',
          backdropFilter: 'blur(20px)',
        }}
      >
        {/* User info */}
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center mb-3 sm:mb-4 lg:mb-6">
            <h1
              className="mb-1 sm:mb-2 text-center responsive-title metallic-title"
              style={{
