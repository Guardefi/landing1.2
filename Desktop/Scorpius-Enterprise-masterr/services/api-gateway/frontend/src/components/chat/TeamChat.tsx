          ...
          {filteredRooms.map(room => (
            ...
            >
              <div className="flex items-center space-x-2 w-full">
                <div className="text-muted-foreground">{getRoomIcon(room.type)}</div>
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Create a new chat room for your team</DialogDescription>
        </DialogHeader>
...
function MessageComponent({
  ...
  return (
    <motion.div
      ...
      className={`group flex gap-3 p-3 hover:bg-gray-50 ${
        ...
        <div className="space-y-0">
          ...
          {typing.length > 0 && (
            <div className="flex items-center gap-3 p-3 text-sm text-muted-foreground">
              ...
              <span>
                {typing.length === 1 ? 'Someone is' : `${typing.length} people are`}{' '}
                typing...
              </span>
            </div>
          )}
