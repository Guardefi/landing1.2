        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">{SUPPORTED_NETWORKS.ethereum.chainId}</Badge>
            </div>
            <p className="text-sm text-muted-foreground break-all">{ethereumRpc}</p>
            <Button
              size="sm"
              variant="outline"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">{SUPPORTED_NETWORKS.arbitrum.chainId}</Badge>
            </div>
            <p className="text-sm text-muted-foreground break-all">{arbitrumRpc}</p>
            <Button
              size="sm"
              variant="outline"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              {etherscanKey ? 'API key configured' : 'Required for blockchain data'}
            </p>
            <Button
              size="sm"
              variant="outline"
...
export function SettingsUsageExample() {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-2">Settings Integration Examples</h3>
        <p className="text-muted-foreground">
          Examples showing how to use settings throughout your application components.
        </p>
      </div>
