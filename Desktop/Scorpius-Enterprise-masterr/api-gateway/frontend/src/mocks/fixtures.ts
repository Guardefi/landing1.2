    ...
    results: {
      ...
      vulnerabilities: [
        ...
        },
        {
          ...
          evidence: ['Conditional transfer failures', 'Whitelist-based restrictions'],
          cvssScore: 7.8,
        },
      ],
      honeypotAnalysis: {
      ...
      complianceChecks: [
        {
          ...
          requirements: ['Standard transfer behavior', 'Proper event emissions'],
        },
      ],
    },
    metadata: {
...
export const mockMempoolAlerts: MempoolAlert[] = [
  ...
  },
  {
    ...
    severity: 'medium',
    description: 'Multiple transactions from same address with increasing gas prices',
    transactionHash:
