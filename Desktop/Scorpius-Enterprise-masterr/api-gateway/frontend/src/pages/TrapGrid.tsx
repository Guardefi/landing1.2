...
const HiveAlert = () => {
  ...
  useEffect(() => {
    const generateMockEvent = (): ThreatEvent => {
      ...
      const statuses: ('detected' | 'analyzing' | 'confirmed' | 'neutralized')[] = [
        'detected',
        'analyzing',
        'confirmed',
        'neutralized',
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-white font-mono">
                  Live Monitoring {isLive && <span className="text-green-400">●</span>}
                </Label>
              </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-300">
                          <span>Attacker: {formatAddress(event.attackerAddress)}</span>
                          <span>
