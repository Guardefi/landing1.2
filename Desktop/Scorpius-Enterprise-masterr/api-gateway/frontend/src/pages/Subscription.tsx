...
export const Subscription: React.FC = () => {
  const { subscription, upgradeToTier, purchaseReport, isLoading } = useSubscription();
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: `Successfully upgraded to ${tier
            .replace('_', ' ')
            .toUpperCase()}`,
        });
      } else {
  ...
  const getDiscountText = (tier: SubscriptionTier) => {
    ...
    if (
      ...
      const savings = Math.round(
        ((pricing.monthly * 12 - pricing.annually) / (pricing.monthly * 12)) * 100,
      );
      return `Save ${savings}%`;
    }
    return null;
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            Choose the perfect plan for your cybersecurity needs. From basic scanning to
            ...
            return (
              ...
              >
                ...
                <CardHeader className="text-center">
                  <div
                    className={`mx-auto p-3 rounded-full bg-gradient-to-r ${getTierColor(
                      tier,
                    )} w-fit mb-4`}
                  >
                    {getTierIcon(tier)}
                  ...
                  <div className="text-3xl font-bold text-white">
                    ...
                    {tier !== SubscriptionTier.ENTERPRISE && (
                      <span className="text-sm text-gray-400 font-normal">
                        {billingCycle === 'annually' ? '/mo billed annually' : '/month'}
                      </span>
                    )}
                  </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={isCurrentTier || isLoading || selectedTier === tier}
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-700">
                      ...
                      <th className="text-center py-3 px-4 text-red-400">Hunter's</th>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Pay $997 once and get lifetime access to Hunter's Edition features
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Yes, we offer a 30-day money-back guarantee for all subscription
                    plans.
                  </p>
                </div>
                <div>
