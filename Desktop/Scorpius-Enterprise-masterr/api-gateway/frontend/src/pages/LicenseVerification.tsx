          ...
          >
            ...
            <form onSubmit={handleLicenseSubmit} className="space-y-6">
              ...
              <Button
                ...
                whileHover={!isVerifying && licenseKey ? { scale: 1.02, y: -2 } : {}}
            ...
            <div className="mt-8 text-center">
              ...
              <div className="mt-4 text-xs text-[#00ff88] bg-[#00ff8820] rounded-lg p-2 border border-[#00ff88]/40">
                ...
                <div className="font-mono text-[#00ffff]">SCORPIUS-ELITE-2024</div>
              </div>
            </div>
          </motion.div>
        ) : (
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-mono text-sm">{feature.name}</div>
