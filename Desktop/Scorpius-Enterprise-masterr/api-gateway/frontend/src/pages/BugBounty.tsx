    ...
    const mockBounties = [
      {
        ...
        description: 'Find critical vulnerabilities in DeFi protocol smart contracts',
        reward: 50000,
        difficulty: 'Expert',
          ...
          <div className="flex items-center gap-4 p-2 bg-black/60 rounded-2xl border border-gray-700">
            {[
              ...
              <motion.button
                ...
                style={{
                  boxShadow:
                    activeTab === tab.id ? '0 0 20px rgba(0, 255, 255, 0.3)' : 'none',
                }}
              >
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-400 font-mono">{bounty.id}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <span
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-orange-400 text-sm">{bounty.timeLeft}</span>
                    </div>
                    <div className="flex items-center gap-2">
