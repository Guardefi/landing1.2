...
import { useSettings, SUPPORTED_NETWORKS, NetworkKey } from '@/context/SettingsContext';
    ...
    <div className="space-y-6">
      ...
      {Object.keys(settings.customRpcUrls).length > 0 && (
        <>
          <Separator />
          <div>
            <h4 className="text-base font-semibold mb-3">Custom RPC Endpoints</h4>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>Remove Custom RPC</AlertDialogTitle>
                              <AlertDialogDescription>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-blue-700">
                RPC endpoints can see your IP address and transaction data. Only use
                trusted providers. Custom RPCs are stored securely and encrypted
                locally.
              </p>
            </div>
          </div>
