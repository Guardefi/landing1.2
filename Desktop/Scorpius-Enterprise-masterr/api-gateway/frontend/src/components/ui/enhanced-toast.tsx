  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className={cn('text-sm leading-relaxed', style.text)}>{toast.message}</div>
  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      {[
        ...
        <ToastContainer key={position} position={position as Toast['position']} />
      ))}
...
export const EnhancedToast = ({ message, type, onClose }: EnhancedToastProps) => {
  const icons = {
    success: CheckCircle,
    error: AlertTriangle,
    warning: AlertCircle,
