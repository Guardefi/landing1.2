...
import {
  ...
  DataFlow,
  ParticleField,
} from "@/components/ui/particle-effects";
import {
  EnhancedAreaChart,
  EnhancedRadialChart,
...
const BridgeNetwork = () => {
  ...
  const bridgeMetrics = [
    { label: "Total Volume", value: "$2.3M", change: "+8.9%", period: "24h" },
    { label: "Active Chains", value: "12", change: "+2", period: "new" },
    { label: "Success Rate", value: "99.7%", change: "+0.1%", period: "7d" },
    {
      label: "Avg Time",
      value: "2.4min",
      change: "-15s",
