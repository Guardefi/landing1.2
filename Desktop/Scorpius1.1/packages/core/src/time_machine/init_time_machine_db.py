...
from models.replay_models import Base, Exploit, ReplaySession, SessionStatus
    ...
    async with AsyncSessionLocal() as session:
        ...
        exploits = [
            Exploit(
                ...
                exploit_metadata=json.dumps(
                    {"value": 2500000, "tokens": ["USDC", "ETH"]}
                ),
            ...
            Exploit(
                ...
                exploit_metadata=json.dumps(
                    {"value": 5200000, "chains": ["ethereum", "polygon"]}
                ),
            ...
            Exploit(
                ...
                exploit_metadata=json.dumps(
                    {"value": 45000, "victim_tx": "0x7777...8888"}
                ),
                ...
                parameters=json.dumps(
                    {
                        ...
                        "analyze": True,
                        "end_block": 18500100,
                        "target_contracts": ["0xDEF123...789"],
                    }
                ),
                results=json.dumps(
                    {"success": True, "transactions_replayed": 15, "gas_used": 2500000}
                ),
                execution_time=45,
        ...
        logger.info(
            f"Created {len(exploits)} sample exploits and {len(replay_sessions)} replay sessions"
        )
