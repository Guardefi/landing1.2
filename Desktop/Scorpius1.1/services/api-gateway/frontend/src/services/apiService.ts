...
export const scannerAPI = {
  ...
  getScanResults: (params?: { page?: number; limit?: number; status?: string }) =>
...
export const mevAPI = {
  ...
  deployStrategy: (strategyData: { name: string; type: string; parameters: any }) =>
  ...
  getPerformanceMetrics: (strategyId?: string) =>
    httpClient.get(`/mev/performance${strategyId ? `?strategy=${strategyId}` : ''}`, {
      baseURL: config.api.mevUrl,
    }),

  getOpportunities: (params?: { page?: number; limit?: number; type?: string }) =>
...
export const mempoolAPI = {
  getTransactions: (params?: {
    ...
    httpClient.get<PaginatedResponse<MempoolTransaction>>('/mempool/transactions', {
...
export const schedulerAPI = {
  ...
  getJob: (jobId: string) => httpClient.get<ScheduledJob>(`/scheduler/jobs/${jobId}`),
  ...
  pauseJob: (jobId: string) => httpClient.post(`/scheduler/jobs/${jobId}/pause`),

  resumeJob: (jobId: string) => httpClient.post(`/scheduler/jobs/${jobId}/resume`),
...
export const settingsAPI = {
  ...
  revokeApiKey: (keyId: string) => httpClient.delete(`/settings/api-keys/${keyId}`),
};
