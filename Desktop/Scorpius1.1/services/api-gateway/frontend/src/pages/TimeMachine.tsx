...
const TimeMachine = () => {
  ...
  const [selectedAttack, setSelectedAttack] = useState<AttackVisualization | null>(
    null,
  );
  ...
  const mockAttacks: AttackVisualization[] = [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          output: '🚨 Reentrancy detected! State not updated before external call',
          status: 'error',
  ...
  const mockEvents = [
    {
      ...
      value: 47.5,
      blockNumber: 18945672,
      txHash: '0x8a9b2c3d4e5f6789012345678901234567890abcdef123456789012345678901234',
      impact: 'High',
      description:
    ...
    },
    {
      ...
      value: 12.3,
      blockNumber: 18945450,
      txHash: '0x7c8b9a0d1e2f3456789012345678901234567890123456789012345678901234',
      impact: 'Medium',
    ...
    },
    {
      ...
      txHash: '0x6b7a8c9d0e1f2345678901234567890123456789012345678901234567890123',
      impact: 'Medium',
    ...
    const playStep = () => {
      if (stepIndex < attack.steps.length) {
        ...
        setTerminalLines(prev => [
          ...
          step.output,
          `Block: ${step.blockNumber} | Gas: ${step.gasUsed?.toLocaleString()} | Tx: ${
        ...
        setTerminalLines(prev => [
          ...
          `🕒 Duration: ${Math.round(
            (attack.steps[attack.steps.length - 1].timestamp.getTime() -
              attack.steps[0].timestamp.getTime()) /
              1000,
          )}s`,
          '='.repeat(80),
        ]);
            ...
            >
              {mockAttacks.map((attack, index) => (
                <motion.div
                  ...
                  className={attack.severity === 'critical' ? 'attack-card' : ''}
                  style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {historicalData.map((event, index) => (
                <motion.div
                  ...
                  onClick={() => {
                    if (event.attackId) {
                      const attack = mockAttacks.find(a => a.id === event.attackId);
                    ...
                    <div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <span style={{ color: '#00ff88' }}>{event.value} ETH</span>
                        </div>
                        <div>
