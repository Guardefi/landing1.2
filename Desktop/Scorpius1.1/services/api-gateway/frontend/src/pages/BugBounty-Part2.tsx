...
const BugBountyPart2 = () => {
  ...
  const filteredBounties = bounties.filter(bounty => {
    if (filters.difficulty && bounty.difficulty !== filters.difficulty) return false;
    if (filters.minReward && bounty.reward < parseInt(filters.minReward)) return false;
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              padding: '2px 8px',
                              borderRadius: '4px',
                              backgroundColor: getDifficultyColor(bounty.difficulty),
                              color: '#000000',
                              fontWeight: '600',
                            }}
                          >
                      ...
                      <div style={{ textAlign: 'right', marginLeft: '20px' }}>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            padding: '8px 16px',
                            backgroundColor:
                              bounty.status === 'Active' ? '#00ff88' : '#666666',
                            color: '#000000',
                            border: 'none',
                            borderRadius: '6px',
                            fontSize: '12px',
                            fontWeight: '600',
                            cursor:
                              bounty.status === 'Active' ? 'pointer' : 'not-allowed',
                            display: 'flex',
                            alignItems: 'center',
                            gap: '6px',
                          }}
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '12px', color: '#999999' }}>
                      {user.bounties} bounties • {user.successRate}% success rate
                    </div>
                  </div>
