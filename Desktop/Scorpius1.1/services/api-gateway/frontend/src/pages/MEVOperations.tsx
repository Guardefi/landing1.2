    ...
    const interval = setInterval(() => {
      setDeployedBots(prev =>
        prev.map(bot => {
          ...
          const statuses: DeployedBot['status'][] = ['active', 'idle', 'processing'];
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                />
                Processing ({deployedBots.filter(b => b.status === 'processing').length}
                )
              </span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div
          ...
          >
            <div style={{ color: '#00ff88' }}>
              Active Transactions:{' '}
              {
                transactions.filter(tx => Date.now() - tx.timestamp.getTime() < 5000)
                  .length
              }
            </div>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <LiveCounter
                      ...
                      suffix={stat.suffix}
                      decimals={stat.suffix === '%' || stat.suffix === 'ETH' ? 1 : 0}
                      duration={2000}
                    />
                  </motion.div>
                  <div
              ...
              <tbody>
                {recentTrades.map((trade, index) => (
                  ...
                  >
                    ...
                    >
                      {Math.floor((Date.now() - trade.timestamp.getTime()) / 60000)}m
                      ago
                    </td>
                  </motion.tr>
                ))}
