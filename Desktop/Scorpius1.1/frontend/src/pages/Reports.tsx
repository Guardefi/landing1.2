...
const Reports = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        // Load report templates (mock data when API is unavailable)
        try {
          ...
          console.warn("Using mock report templates");
          // Templates are already set in initial state, so no need to do anything
        }

        // Load scan results (mock data when API is unavailable)
        try {
          ...
          console.warn("Using mock scan results");
          // Scan results are already set in initial state
        }

        // Load generated reports (mock data when API is unavailable)
        try {
          ...
          console.warn("Using mock generated reports");
          // Generated reports are already set in initial state
        }
