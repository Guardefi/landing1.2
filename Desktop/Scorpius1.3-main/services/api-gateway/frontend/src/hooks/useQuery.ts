...
export const queryKeys = {
  ...
  mempool: {
    ...
    alerts: (filters?: Record<string, any>) => ['mempool', 'alerts', filters] as const,
  ...
  scheduler: {
    ...
    jobs: (filters?: Record<string, any>) => ['scheduler', 'jobs', filters] as const,
...
export function useInfiniteQuery<T = any>(
  ...
  options: {
    limit?: number;
    getNextPageParam?: (lastPage: ApiResponse<T>, pages: ApiResponse<T>[]) => any;
  } = {},
) {
