...
import { Shield, Lock, AlertTriangle, Crown, Zap, CheckCircle } from 'lucide-react';
...
function TierUpgradeModal({ currentTier, requiredTier, feature }: TierUpgradeProps) {
                ...
                <div className="mb-4">
                  <div className="flex items-baseline gap-1">
                    <span className="text-3xl font-bold">
                      ${tierPricing[requiredTier as keyof typeof tierPricing]?.monthly}
                    </span>
                    <span className="text-gray-600">/month</span>
                  </div>
                  <p className="text-sm text-gray-600">Save 20% with yearly billing</p>
                </div>
