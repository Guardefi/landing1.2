...
// Enhanced API request helper that routes all requests to single backend
const apiRequest = async (endpoint: string, options: RequestInit = {}) => {
  // All requests go to the single backend
...
export const scannerAPI = {
  analyzeContract: async (contractAddress: string, scanType: string = 'full') => {
