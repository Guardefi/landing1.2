                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">
                        {mode === "login" ? "Hello Dark Forest," : "Join Scorpius"}
                      </h1>
                      <p className="text-[1.8rem] text-white/70 font-light">
                        {mode === "login" ? "Meet Scorpius." : "Secure your blockchain future."}
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleEmailSubmit} className="space-y-4">
                        ...
                        <div className="relative">
                          ...
                          <button
                            type="submit"
                            disabled={isLoading || (mode === "register" && !fullName)}
                        ...
                        {error && (
                          <div className="text-red-400 text-sm text-center bg-red-500/10 rounded-full py-2 px-4">
                            {error}
                          </div>
                        )}
                      </form>
