...
class FlashLoanArbitrageStrategy(MEVStrategy):
    ...
    def __init__(self) -> None:
        ...
        self.logger.info(
            f"FlashLoan strategy initialized - Rust: {self.rust_enabled}, Min profit: {self.min_profit_threshold}"
        )
    ...
    async def _call_rust_scanner(self) -> list[dict]:
        ...
        try:
            ...
            if proc.returncode != 0:
                self.logger.error(
                    f"Rust scanner failed with code {proc.returncode}: {stderr_data.decode()}"
                )
                return []
    ...
    async def _execute_rust_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Executing Rust MEV opportunity: {opportunity.estimated_profit:.6f} ETH profit"
            )
            ...
            if execution_success:
                ...
                self.logger.info(
                    f"✅ Rust opportunity executed successfully - Profit: {opportunity.estimated_profit:.6f} ETH"
                )
            else:
                self.stats.failed_executions += 1
                self.logger.warning(
                    f"❌ Rust opportunity execution failed - Would have profited: {opportunity.estimated_profit:.6f} ETH"
                )
    ...
    async def _execute_python_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Executing Python DEX opportunity: {opportunity.estimated_profit:.6f} ETH profit"
            )
            ...
            if execution_success:
                ...
                self.stats.failed_executions += 1
                self.logger.warning(
                    f"❌ Python DEX opportunity failed - Target profit: {opportunity.estimated_profit:.6f} ETH"
                )
...
class SandwichAttackStrategy(MEVStrategy):
    ...
    async def execute_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Executing sandwich attack - Target: {execution_data['target_tx_value_eth']:.1f} ETH, Profit: {opportunity.estimated_profit:.6f} ETH"
            )
            ...
            if execution_success:
                ...
                self.stats.total_profit += opportunity.estimated_profit
                self.logger.info(
                    f"✅ Sandwich attack executed successfully - Profit: {opportunity.estimated_profit:.6f} ETH"
                )
            else:
                self.stats.failed_executions += 1
                self.logger.warning(
...
class LiquidationBotStrategy(MEVStrategy):
    ...
    def __init__(self) -> None:
        ...
        self.logger.info(
            f"Liquidation strategy initialized - Health factor threshold: {self.health_factor_threshold}"
        )
    ...
    async def execute_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            ...
            if execution_success:
                ...
                self.stats.total_profit += opportunity.estimated_profit
                self.logger.info(
                    f"✅ {protocol} liquidation executed successfully - Profit: {opportunity.estimated_profit:.6f} ETH"
                )
            else:
                self.stats.failed_executions += 1
                self.logger.warning(
...
class OracleManipulationStrategy(MEVStrategy):
    ...
    async def execute_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            self.logger.info(
                f"Executing oracle manipulation response: {opportunity.estimated_profit} ETH profit"
            )
...
class GovernanceAttackStrategy(MEVStrategy):
    ...
    async def execute_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            self.logger.info(
                f"Executing governance strategy: {opportunity.estimated_profit} ETH profit"
            )
