...
class TestAPIEndpoints:
    ...
    def test_create_rule(self, mock_db, test_client: TestClient):
        ...
        mock_db.create_rule = AsyncMock(return_value={
            "id": "rule-789",
            "name": "Test Rule",
    ...
    def test_websocket_broadcast(self, mock_manager, test_client: TestClient):
        ...
        async def test_broadcast():
            await mock_manager.broadcast(json.dumps({
                "type": "alert",
                "data": {
                    "id": "alert-123",
                    "severity": "high",
    ...
    def test_get_mev_opportunities(self, mock_db, test_client: TestClient):
        ...
        mock_db.get_mev_opportunities = AsyncMock(return_value=[
            {
                "id": "mev-123",
                "transaction_hash": "0x123",
                "chain_id": 1,
    ...
    def test_request_validation(self, test_client: TestClient):
        ...
        headers = {"Authorization": "Bearer test-token"}
        response = test_client.get("/api/v1/transactions?limit=invalid", headers=headers)
