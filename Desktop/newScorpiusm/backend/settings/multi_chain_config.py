...
class MultiChainConfig:
    ...
    def _load_chain_configs(self) -> None:
        ...
        self.chains[SupportedChain.ETHEREUM] = ChainConfig(
            ...
            builder_endpoints=["https://builder0x69.io", "https://rpc.payload.de"],
    ...
    def get_chain_config(self, chain: SupportedChain) -> ChainConfig | None:
    ...
    def get_chains_with_flashloans(self) -> list[SupportedChain]:
        ...
        return [
            chain for chain, config in self.chains.items() if config.flashloan_providers
        ]
    ...
    def get_cross_chain_opportunities(self) -> list[tuple]:
        ...
        for i, chain1 in enumerate(chains):
            for chain2 in chains[i + 1 :]:
                ...
                # Find common tokens
                common_stables = set(config1.stable_coins.keys()) & set(
                    config2.stable_coins.keys()
                )
                if common_stables:
