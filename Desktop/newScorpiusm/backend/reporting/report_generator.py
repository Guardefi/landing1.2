...
<body>
    ...
    async def generate_report(self, db: AsyncSession, scan_id: str) -> str | None:
        """
        ...
        try:
            ...
            for finding in findings_data:
                vuln = VulnerabilityFinding(
                    ...
                    mitigation=finding.get(
                        "mitigation", "Review and fix the identified issue"
                    ),
    ...
    def _parse_ai_analysis(self, ai_analysis_json: str) -> AIAnalysis | None:
        ...
        try:
            ...
            return AIAnalysis(
                ...
                exploitation_complexity=analysis_data.get(
...
async def generate_scan_report(db: AsyncSession, scan_id: str) -> str | None:
    """
