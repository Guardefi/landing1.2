...
class SecurityConfig:
    ...
    private_key_dev: str | None = None  # Only for development
...
class Config:
    ...
    def _validate_config(self) -> None:
        ...
        for network_name, network_config in self._config_data.get(
            "networks", {}
        ).items():
    ...
    async def get_private_key(self, wallet_address: str) -> str | None:
        """
    ...
    async def _get_kms_private_key(self, wallet_address: str) -> str | None:
        """
