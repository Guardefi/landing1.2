...
class TrainingDataSeeder:
    ...
    async def seed_all_data(self, db: AsyncSession):
        ...
        try:
            ...
            await self.seed_assessments(db, courses)
    ...
    async def seed_badges(self, db: AsyncSession) -> list[Badge]:
        ...
        badges_data = [
            # Module completion badges
            {
                ...
                "criteria": {
                    "module_completion": "security_fundamentals",
                    "min_score": 80,
                },
                "points_awarded": 100,
                "rarity_level": "common",
            ...
            },
            {
                ...
                "badge_type": BadgeType.COMPLETION,
                "criteria": {
                    "module_completion": "incident_response",
                    "forensics_cases": 5,
                },
                "points_awarded": 130,
                "rarity_level": "rare",
            ...
            },
            {
                ...
                "badge_type": BadgeType.COMPLETION,
                "criteria": {
                    "module_completion": "vulnerability_management",
                    "scans_performed": 10,
                },
                "points_awarded": 110,
                "rarity_level": "common",
            ...
            },
            {
                ...
                "badge_type": BadgeType.COMPLETION,
                "criteria": {
                    "module_completion": "ethical_hacking",
                    "penetration_tests": 3,
                },
                "points_awarded": 140,
                "rarity_level": "rare",
            ...
            },
            {
                ...
                "badge_type": BadgeType.COMPLETION,
                "criteria": {
                    "module_completion": "advanced_operations",
    ...
    async def seed_modules(
        self, db: AsyncSession, badges: list[Badge]
    ) -> list[TrainingModule]:
    ...
    async def seed_courses(
        self, db: AsyncSession, modules: list[TrainingModule]
    ) -> list[Course]:
    ...
    async def seed_assessments(
        self, db: AsyncSession, courses: list[Course]
    ) -> list[Assessment]:
    ...
    async def seed_sample_progress(
        self,
        db: AsyncSession,
        users: list[TrainingUser],
        ...
        for i, user in enumerate(users):
            ...
            modules_to_progress = modules[
                : i + 2
            ]  # First user gets 2 modules, second gets 3, etc.
            ...
            for j, module in enumerate(modules_to_progress):
                ...
                progress = UserProgress(
                    ...
                    time_spent_minutes=int(
                        module.estimated_hours * 60 * (progress_percentage / 100)
                    ),
