...
import { useSettings, API_SERVICES, ApiServiceKey } from '@/context/SettingsContext';
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="custom-api-description">Description (Optional)</Label>
            <Input
...
export function APIKeysSettings() {
  ...
  const handleBulkValidate = async () => {
    ...
    const keysToTest = services.filter(
      service => settings.apiKeys[service] && settings.apiKeys[service].length > 0,
    );
  ...
  const getRequiredKeysCount = () => {
    return Object.values(API_SERVICES).filter(service => service.required).length;
  };
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 font-medium">{getConfiguredKeysCount()}</span>
            </div>
            <div>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Are you sure you want to remove the API key for "{name}
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-blue-700">
                API keys are encrypted and stored locally on your device. Never share
                your API keys with others. Some features may require specific API keys
