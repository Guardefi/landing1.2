  ...
  useEffect(() => {
    const mockCourses = [
      ...
      },
      {
        ...
        description: 'Master MEV extraction techniques and arbitrage opportunities',
      ...
      },
      {
        ...
        description: 'Deep dive into DeFi protocol mechanics and security analysis',
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveStats(prev => ({
        ...
        skillLevel: Math.min(100, prev.skillLevel + (Math.random() > 0.9 ? 1 : 0)),
      }));
    }, 3000);
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                ...
                <LiveCounter
                  target={typeof stat.value === 'string' ? stat.value : stat.value}
          ...
          <div className="flex items-center gap-4 p-2 bg-black/60 rounded-2xl border border-gray-700">
            {[
              ...
              <motion.button
                ...
                style={{
                  boxShadow:
                    activeTab === tab.id ? '0 0 20px rgba(168, 85, 247, 0.3)' : 'none',
                }}
              >
                ...
                >
                      ...
                      <motion.div
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${getCategoryColor(
                            course.category,
                          )}20, ${getCategoryColor(course.category)}40)`,
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-blue-400 text-sm">{course.duration}</span>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-purple-400 text-sm">{course.students}</span>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      <motion.div
                        ...
                        className={`p-2 rounded-lg ${
                          achievement.unlocked ? 'bg-yellow-400/20' : 'bg-gray-700'
                        }`}
                      >
                        <Award
                          className="w-5 h-5"
