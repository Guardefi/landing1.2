...
const SimSniper = () => {
  ...
  const mockSimulations: FlashbotsSim[] = [
    {
      id: '1',
      simHash: '0x8a9b2c3d4e5f6789012345678901234567890abcdef123456789012345678901234',
    ...
    {
      id: '2',
      simHash: '0x9b8a7c6d5e4f3210987654321098765432109876543210987654321098765432',
    ...
    {
      id: '3',
      simHash: '0x7c8b9a0d1e2f3456789012345678901234567890123456789012345678901234',
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: isLive ? '0 0 15px rgba(0, 255, 255, 0.6)' : 'none',
                }}
              />
              <Switch
                checked={isLive}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              />
              <Label style={{ color: '#cccccc', fontWeight: '500' }}>Sim-Only</Label>
            </div>
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: '100%',
                                backgroundColor: getScoreColor(selectedSim.simScore),
                                boxShadow: `0 0 15px ${getScoreColor(
                      ...
                      <div>
                        ...
                        <div
                          style={{
                            fontSize: '24px',
                            fontWeight: '700',
                            color: selectedSim.profit > 1 ? '#00ff88' : '#ffaa00',
                            fontFamily: "'JetBrains Mono', monospace",
                            textShadow: `0 0 10px ${
                            ...
                            <span
                              style={{
                                ...
                                backgroundColor: selectedSim.simOnly
                                  ? 'rgba(0, 255, 255, 0.2)'
                                  : 'rgba(255, 170, 0, 0.2)',
                                color: selectedSim.simOnly ? '#00ffff' : '#ffaa00',
                                border: `1px solid ${
                                  selectedSim.simOnly ? '#00ffff' : '#ffaa00'
                                }40`,
                              }}
                            >
