  ...
  const mockThreats: ThreatMatch[] = [
    {
      ...
      description: 'Advanced honeypot with reentrancy trap and balance manipulation',
    ...
    },
    {
      ...
      description: 'Contract pattern associated with liquidity removal exploits',
                      ...
                      <div>
                        ...
                        >
                          <motion.div
                            ...
                            style={{
                              height: '100%',
                              backgroundColor: getSimilarityColor(threat.similarity),
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: '100%',
                            background: `linear-gradient(90deg, ${getSimilarityColor(
                              selectedMatch.similarity,
                            )}, ${getSimilarityColor(selectedMatch.similarity)}80)`,
