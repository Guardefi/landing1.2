        ...
        try:
            ...
            async with self.db_pool.acquire() as conn:
                ...
                if not dry_run:
                    ...
                    result.bytes_freed = max(
                        0, table_size_before - table_size_after)
                else:
        ...
        try:
            ...
            for column in policy.anonymize_columns:
                ...
                if "email" in column.lower():
                    anonymization_updates.append(
                        f"{column} = 'anonymized@example.com'")
    ...
    async def archive_logs_to_s3(
        ...
        try:
            bucket_name = self.config.get(
                "archive_bucket", "scorpius-log-archive")
