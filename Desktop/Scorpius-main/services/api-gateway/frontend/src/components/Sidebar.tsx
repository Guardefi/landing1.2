          ...
          >
            ...
            >
              <div className="scorpion-glow">
                <UserLogo size={isCollapsed && !isHovered ? 20 : 28} color="#00ff88" />
              </div>
              {/* Animated ring */}
              <motion.div
                animate={{ rotate: 360 }}
        ...
        >
          ...
          >
            {navigationItems.map((item, index) => {
              ...
              const isCritical = ['TrapGrid', 'SimSniper', 'CodeMatcher'].includes(
                item.name,
              );
                ...
                >
                  <NavLink
                    ...
                    style={({ isActive }) => ({
                      ...
                      padding: isCollapsed && !isHovered ? '12px 8px' : '14px 16px',
