#!/usr/bin/env python3
from services.api_gateway.main import SERVICE_ROUTE_MAP, app  # type: ignore
...
globals().update({
    ...
    print(f"SKIPPED: {rf"Could not import api gateway module: {e}", allow_module_level=True}")
...
# # @pytest.mark...  # Fixed: removed pytest decorator
    ...
    # The double underscore ensures prefix mismatch hence unknown prefix 404
    # will trigger
