    ...
    def get_scan_history(self):
        ...
        params = {
            "limit": random.randint(
                10, 50), "offset": random.randint(
                0, 100)}

        self.make_authenticated_request(
            "GET", "/api/scanner/scans", params=params)
...
class BridgeServiceUser(ScorpiusUser):
    ...
    def get_transfer_history(self):
        ...
        self.make_authenticated_request(
            "GET", "/api/bridge/transfers", params=params)
...
class MempoolServiceUser(ScorpiusUser):
    ...
    def get_pending_transactions(self):
        ...
        self.make_authenticated_request(
            "GET", "/api/mempool/pending", params=params)
    ...
    def analyze_transaction(self):
        ...
        self.make_authenticated_request(
            "GET", f"/api/mempool/analyze/{tx_hash}")
...
class MEVServiceUser(ScorpiusUser):
    ...
    def get_opportunities(self):
        ...
        self.make_authenticated_request(
            "GET", "/api/mev/opportunities", params=params)
...
class HoneypotServiceUser(ScorpiusUser):
    ...
    def get_detected_honeypots(self):
        ...
        self.make_authenticated_request(
            "GET", "/api/honeypot/detected", params=params)
