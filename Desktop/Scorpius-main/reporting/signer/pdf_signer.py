...
class PDFSigner:
    ...
    async def sign_pdf(
        ...
        if not self.certificate or not self.private_key:
            raise ValueError(
                "Certificate and private key required for signing")
                ...
                pdf_writer.add_metadata(
                    {
                        ...
                        "/SignatureTimestamp": signature_metadata[
                            "timestamp"
                        ].isoformat(),
                    }
                )
    ...
    def get_certificate_info(self) -> Optional[Dict[str, Any]]:
        ...
        return {
            "subject": {
                ...
                "organization": self._get_attribute_value(
                    subject, NameOID.ORGANIZATION_NAME
                ),
            ...
            "issuer": {
                ...
                "organization": self._get_attribute_value(
                    issuer, NameOID.ORGANIZATION_NAME
                ),
