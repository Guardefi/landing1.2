...
class BridgeSettings(BaseSettings):
    ...
    consensus_threshold: float = Field(
        default=0.67,
        description="Consensus threshold (67% of validators must agree)")
    ...
    # FEES AND LIMITS
    # =============================================================================
    base_bridge_fee_percentage: Decimal = Field(default=Decimal(
        "0.003"), description="Base bridge fee percentage (0.3%)")
    min_transfer_amount: Decimal = Field(
        default=Decimal("1.0"),
        description="Minimum transfer amount in USD equivalent")
