...
class User(Base):
    ...
    mempool_transactions = relationship(
    "MempoolTransaction", back_populates = "user")
...
from sqlalchemy import User  # Create default admin user if it doesn't exist
