...
class MEVConfig:
    ...
    flashbots_auth_key: str | None = None
    ...
    eden_endpoint: str | None = None
    taichi_endpoint: str | None = None
    ...
    # Flash Loan Settings
    flashloan_contract_address: str | None = None
    supported_flashloan_providers: list[str] = field(
...
class UltimateMEVConfigManager:
    ...
    def _validate_config(self):
        ...
        if self.config.private_key and not self.config.private_key.startswith(
                "0x"):
...
def load_mev_config() -> dict[str, Any]:
    ...
    return {
        ...
        "strategies": (
            config_manager.strategies_config
            if hasattr(config_manager, "strategies_config")
            else {
