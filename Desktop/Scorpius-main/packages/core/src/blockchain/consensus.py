...
class ConsensusEngine:
    ...
    def __init__(
            self,
            consensus_type: ConsensusType = ConsensusType.WEIGHTED_MAJORITY):
    ...
    async def reach_consensus(
        ...
        try:
            ...
            logger.error(
                f"Consensus error for transfer {
    ...
    async def _gather_votes(
        ...
        tasks = [validator.validate_transfer(
            transfer) for validator in validators]
        ...
        try:
            ...
            logger.warning(
                f"Validation timeout for transfer {
