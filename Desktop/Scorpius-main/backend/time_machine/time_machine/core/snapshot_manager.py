...
class SnapshotManager:
    ...
    async def create_snapshot(
        ...
        snapshot_id = self._generate_snapshot_id(
            branch_id, block_number, content_hash)
    ...
    def list_snapshots(
            self, branch_id: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    async def get_snapshot_info(
            self, snapshot_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def _find_duplicate_snapshot(
            self, content_hash: str) -> Optional[str]:
