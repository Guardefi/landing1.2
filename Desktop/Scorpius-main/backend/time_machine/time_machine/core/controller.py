...
class TimeMachineEngine:
    ...
    async def patch(self, branch: Branch,
                    patch_ops: List[Dict[str, str]]) -> Branch:
        """
    ...
    async def get_timeline_events(
            self, branch_id: str) -> AsyncIterator[TimelineEvent]:
        """
    ...
    def get_forensic_session(
            self,
            session_id: str) -> Optional[ForensicSession]:
