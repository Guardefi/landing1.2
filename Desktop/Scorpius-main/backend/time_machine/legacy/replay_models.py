...
class Exploit(Base, TimestampMixin):
    ...
    transaction_hashes = Column(JSON, nullable=False)
...
class EventLog(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index(
            "idx_event_contract_signature",
            "contract_address",
            "event_signature"),
        Index(
            "idx_event_suspicious",
            "is_suspicious",
            "anomaly_score"),
    )
...
class AnalysisResult(Base, TimestampMixin):
    ...
    # Analysis plugin that generated this result
