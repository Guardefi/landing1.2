...
# Test script to verify the FastAPI server can start and all endpoints are
# accessible.
    """
...
# Add current directory to path
    ...
    print(
    f"[PASS] Detailed health check response: {
    detailed_response['status'}}")
    except Exception as e:
    print(
    f"[WARNING]  Detailed health check failed (expected without DB/Redis): {e}")
