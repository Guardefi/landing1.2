...
class TransactionResponse(BaseModel):
    ...
    to_address: Optional[str] = Field(
        None, alias="to", description="Recipient address")
...
class AlertResponse(BaseModel):
    ...
    rule_id: UUID = Field(...,
                          description="ID of the rule that triggered this alert")
    ...
    rule_name: Optional[str] = Field(
        None, description="Name of the triggering rule")
...
class RuleCondition(BaseModel):
    ...
    field: Optional[str] = Field(
        None, description="Transaction field to evaluate")
    ...
    def validate_condition_type(cls, v):
        ...
        if v not in valid_types:
            raise ValueError(
                f"Invalid condition type. Must be one of: {valid_types}")
        return v
...
class RuleAction(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Alert description template")
    tags: Optional[list[str]] = Field(
        None, description="Tags to add to created alerts")
    ...
    def validate_action_type(cls, v):
        ...
        if v not in valid_types:
            raise ValueError(
                f"Invalid action type. Must be one of: {valid_types}")
        return v
...
class RuleRequest(BaseModel):
    ...
    tags: Optional[list[str]] = Field(
        default_factory=list, description="Rule tags")
...
class RuleResponse(BaseModel):
    ...
    created_by: Optional[str] = Field(
        None, description="User who created the rule")
...
class SystemStatsResponse(BaseModel):
    ...
    chains_monitored: int = Field(...,
                                  description="Number of chains being monitored")
...
class NotificationSettings(BaseModel):
    ...
    webhook_enabled: bool = Field(
        False, description="Enable webhook notifications")
    slack_enabled: bool = Field(
        False, description="Enable Slack notifications")
    ...
    slack_webhook_url: Optional[str] = Field(
        None, description="Slack webhook URL")
...
class APIKeyRequest(BaseModel):
    ...
    expires_at: Optional[datetime] = Field(
        None, description="When the API key expires")
