...
from .models import BillingEvent, OrganizationUsage
...
billing_events = Counter(
    "scorpius_billing_events_total", "Total billing events", [
        "event_type", "org_id"])
api_latency = Histogram(
    "scorpius_usage_api_duration_seconds",
...
async def update_billing(
    ...
    try:
        ...
        billing_events.labels(
            event_type="plan_update",
            org_id=update.org_id).inc()
