    ...
    async def _get_feature_usage_breakdown(self) -> Dict:
        ...
        try:
            ...
            for key in usage_keys:
                ...
                feature_usage[key_tuple] = feature_usage.get(
                    key_tuple, 0) + int(usage)
