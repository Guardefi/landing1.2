...
class UsageTracker:
    ...
    async def record_usage(
        ...
        try:
            ...
            if not current_reset or datetime.fromisoformat(
            ...
            record_key = f"{
                self.usage_prefix}records:{org_id}:{
                timestamp.isoformat()}"
    ...
    async def get_organization_usage(
            self, org_id: str) -> Optional[OrganizationUsage]:
    ...
    async def update_organization_limits(
        ...
        try:
            ...
            logger.info(
                f"Updated organization limits: org={org_id}, plan={plan}")
    ...
    async def record_billing_event(self, event: BillingEvent):
        ...
        try:
            ...
            logger.info(
                f"Recorded billing event: {
                    event.event_type} for org {
                    event.org_id}"
            )
