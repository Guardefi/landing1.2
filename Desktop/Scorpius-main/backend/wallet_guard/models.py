...
class WalletCheckRequest(BaseModel):
    ...
    chains: List[ChainEnum] = Field(
        default=[
            ChainEnum.ETHEREUM],
        description="Blockchain networks to check")
...
class ApprovalRisk(BaseModel):
    ...
    approved_amount: str = Field(...,
                                 description="Approved amount or token ID")
...
class DrainerSignature(BaseModel):
    ...
    description: str = Field(...,
                             description="Description of the drainer pattern")
...
class SpoofedApproval(BaseModel):
    ...
    real_address: str = Field(...,
                              description="Real contract address being spoofed")
...
class RevokeResponse(BaseModel):
    ...
    total_gas_estimate: str = Field(...,
                                    description="Total estimated gas cost")
    transaction_hash: str = Field(...,
                                  description="Transaction batch hash for audit")
