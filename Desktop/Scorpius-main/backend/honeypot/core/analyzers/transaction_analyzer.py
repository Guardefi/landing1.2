...
class TransactionAnalyzer:
    ...
    async def analyze_transactions(
            self, transactions: List[Dict]) -> Dict[str, Any]:
        ...
        for deposit in deposits:
            ...
            for withdrawal in withdrawals:
                ...
                if (0 < time_diff < 300) and (
                        withdrawal_value > deposit_value * 0.7):
    ...
    async def _detect_owner_only_withdrawals(
        ...
        # Identify likely contract owner (first address to interact or
        # deployer)
