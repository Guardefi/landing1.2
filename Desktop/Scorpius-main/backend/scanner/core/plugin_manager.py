...
class ScannerPlugin(ABC):
    ...
    # Scan types this plugin supports
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supported_scan_types": [
                st.value for st in self.SUPPORTED_SCAN_TYPES],
...
class PluginManager:
    ...
    def __init__(self, plugin_dirs: List[str] = None):
        ...
        # name -> plugin class
        self.plugin_classes: Dict[str, Type[ScannerPlugin]] = {}
        ...
        logger.info(
            f"Plugin Manager initialized with directories: {
                self.plugin_dirs}"
        )
                ...
                for dir_name in dirs:
                    ...
                    rel_path = os.path.relpath(
                        os.path.join(
                            root,
                            dir_name),
                        start=os.path.dirname(plugin_dir))
    ...
    def register_plugin(self, plugin_module_path: str) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Failed to import plugin module {plugin_module_path}: {e}")
            return False
        except Exception as e:
            logger.error(
                f"Error registering plugin from {plugin_module_path}: {e}")
            return False
        ...
        for name, plugin in self.plugins.items():
            try:
                ...
                if success:
                    ...
                    logger.warning(
                        f"Plugin {name} initialization returned False")
    ...
    def get_plugins_by_scan_type(
            self, scan_type: ScanType) -> Dict[str, ScannerPlugin]:
