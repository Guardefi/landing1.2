...
# Tests all API functionality including comparison, search, indexing, and
# WebSocket
"""
...
class TestWebSocketConnection:
    ...
    async def test_websocket_connection(self):
        ...
        try:
            ...
            print(f"SKIPPED: {rf"WebSocket server not available: {e}"}")
    ...
    async def test_websocket_subscription(self):
        ...
        try:
            ...
            async with websockets.connect(uri) as websocket:
                ...
                subscribe_message = {
    "type": "subscribe", "subscription": "all"}
...
class TestErrorHandling:
    ...
    def test_unicode_in_bytecode(self):
        ...
        payload = {
            "bytecode1": "60806040523480156100üß EURü",
    print(f"Error: {str(e)}")
        }
