...
class TestBytecodeNormalizer:
    ...
    def test_instruction_parsing(self, normalizer):
        ...
        push_instructions = [inst for inst in instructions if inst['opcode'].startswith('PUSH')]
    ...
    def test_constant_normalization(self, normalizer, sample_bytecodes):
        ...
        for inst in push_instructions:
            if 'operand' in inst:
                ...
                assert inst['operand'] in ['CONST', '<CONST>'] or inst['operand'].startswith('CONST_')
    ...
    def test_nop_removal(self, normalizer):
        ...
        bytecode_with_nops = "60015b60025b6003"  # PUSH1 1, JUMPDEST, PUSH1 2, JUMPDEST, PUSH1 3
        ...
        if normalizer.config['remove_nops']:
            jumpdest_count = len([inst for inst in instructions if inst['opcode'] == 'JUMPDEST'])
