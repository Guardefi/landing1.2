...
class BytecodeTokenizer:
    ...
    def _build_vocab(self):
        ...
        evm_opcodes = [
            ...
            'GASLIMIT', 'POP', 'MLOAD', 'MSTORE', 'MSTORE8', 'SLOAD',
    ...
    def _hex_to_opcode(self, hex_byte: str) -> str:
        ...
        try:
            ...
            opcode_map = {
                ...
                0x55: 'SSTORE', 0x56: 'JUMP', 0x57: 'JUMPI', 0x5b: 'JUMPDEST',
...
def generate_synthetic_data(num_pairs: int = 1000) -> dict:
    ...
    for i in range(num_pairs):
        ...
        if i % 2 == 0:
            ...
            bytecode1 = base_bytecode + hex(i)[2:].zfill(4)
            bytecode2 = "608060405234801561001057600080fd5b50" + hex(i * 10)[2:].zfill(4)  # Different
            label = 0
...
async def main():
    ...
    parser.add_argument('--config', type=str, default='configs/siamese_config.yaml',
    ...
    train_pairs, val_pairs, train_labels, val_labels = train_test_split(
        train_data['pairs'], train_data['labels'], 
        test_size=0.2, stratify=train_data['labels'], random_state=42
    )
