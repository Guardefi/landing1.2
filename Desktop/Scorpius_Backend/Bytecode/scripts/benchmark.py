...
from utils.metrics import BenchmarkSuite, SimilarityMetrics, PerformanceMonitor
...
class ComprehensiveBenchmark:
    ...
    async def _setup_test_data(self):
        ...
        test_bytecodes = [
            ("6080604052348015600f57600080fd5b50", {"name": "test1", "type": "constructor"}),
            ("608060405234801561001057600080fd5b50", {"name": "test2", "type": "constructor"}),
            ("6080604052600436106100295760003560e01c", {"name": "test3", "type": "dispatcher"}),
            ("608060405260043610610029576000", {"name": "test4", "type": "dispatcher"}),
            ("6080604052348015600f57600080fd5b506004361061003b5760003560e01c", {"name": "test5", "type": "complex"}),
        ]
    ...
    async def run_similarity_benchmark(self) -> Dict:
        ...
        test_pairs = [
            ("6080604052348015600f57600080fd5b50", "608060405234801561001057600080fd5b50"),
            ("6080604052600436106100295760003560e01c", "608060405260043610610029576000"),
            ("6080604052348015600f57600080fd5b50", "6080604052600436106100295760003560e01c"),
        ]
        ...
        results['average_time'] = sum(results['comparison_times']) / len(results['comparison_times'])
        results['throughput'] = results['total_comparisons'] / results['total_time']
        
        logger.info(f"Similarity benchmark completed: {results['total_comparisons']} comparisons in {results['total_time']:.2f}s")
    ...
    async def run_search_benchmark(self) -> Dict:
        ...
        logger.info(f"Search benchmark completed: {results['total_searches']} searches in {results['total_time']:.2f}s")
    ...
    async def run_indexing_benchmark(self) -> Dict:
        ...
        logger.info(f"Indexing benchmark completed: {results['total_indexed']} bytecodes in {results['total_time']:.2f}s")
    ...
    async def run_accuracy_benchmark(self) -> Dict:
        ...
        similar_pairs = [
            ("6080604052348015600f57600080fd5b50", "6080604052348015600f57600080fd5b50"),  # Identical
            ("6080604052348015600f57600080fd5b50", "6080604052348015600f57600080fd5b51"),  # Very similar
        ]
        
        dissimilar_pairs = [
            ("6080604052348015600f57600080fd5b50", "608060405234801561001057600080fd5b50"),  # Different
        ...
        # Calculate metrics
        metrics = SimilarityMetrics.calculate_comprehensive_metrics(y_true, y_pred, y_scores)
        
        logger.info(f"Accuracy benchmark completed - Accuracy: {metrics['accuracy']:.3f}, F1: {metrics['f1_score']:.3f}")
    ...
    async def run_memory_benchmark(self) -> Dict:
        ...
        logger.info(f"Memory benchmark completed - Memory increase: {memory_increase:.2f} MB")
    ...
    async def run_all_benchmarks(self) -> Dict:
        ...
        try:
            all_results['benchmarks']['similarity'] = await self.run_similarity_benchmark()
...
async def main():
    ...
    parser.add_argument('--benchmark', type=str, choices=['all', 'similarity', 'search', 'indexing', 'accuracy', 'memory'],
