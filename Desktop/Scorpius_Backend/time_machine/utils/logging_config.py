...
def log_security_event(logger: logging.Logger, event_type: str, details: Dict[str, Any], **context):
    """Log security events"""
    logger.warning(
...
def log_audit_event(logger: logging.Logger, action: str, resource: str, user: str = None, **context):
    """Log audit events"""
    logger.info(
...
if __name__ == '__main__':
    ...
    log_security_event(logger.logger, "invalid_token", {"token": "***", "ip": "192.168.1.1"})
