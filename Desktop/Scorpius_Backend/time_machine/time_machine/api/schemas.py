...
from ..core.models import VMBackend, SessionType, PatchType, FrameType
...
class ReplayRequest(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Description of the replay purpose")
    block_number: Optional[int] = Field(None, description="Specific block number to replay")
    tx_hash: Optional[str] = Field(None, description="Specific transaction hash to replay")
    ...
    patches: List[Dict[str, Any]] = Field(default_factory=list, description="State patches to apply")
...
class ForensicSessionRequest(BaseModel):
    ...
    target_contracts: List[str] = Field(default_factory=list, description="Target contract addresses")
    target_transactions: List[str] = Field(default_factory=list, description="Target transaction hashes")
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Additional metadata")
