...
class ForensicSession:
    ...
    def add_bookmark(self, name: str, block_number: int, tx_index: int, 
...
class AnalysisPlugin(ABC):
    ...
    @abstractmethod
    async def analyze(self, events: List[TimelineEvent], 
...
def create_forensic_session(name: str, session_type: SessionType, 
...
def create_exploit_patch(contract_address: str, slot: str, value: str, 
...
def create_balance_patch(address: str, balance: str, 
                        description: str = "") -> Patch:
...
def create_bookmark(name: str, block_number: int, tx_index: int = 0,
