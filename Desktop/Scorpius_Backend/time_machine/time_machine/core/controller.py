...
from .models import (
    ReplayJob, Branch, TimelineEvent, Patch, Diff, ForensicSession,
    StateManipulation, AnalysisPlugin, VMBackend, JobStatus, SessionType
)
from .execution_vm import get_vm, BaseVMAdapter
...
class TimeMachineEngine:
    ...
    async def diff(self, from_branch_id: str, to_branch_id: str) -> Diff:
        ...
        from_state = await self.snapshot_manager.restore_snapshot(from_branch.snapshot_id)
    ...
    async def create_forensic_session(self, name: str, session_type: SessionType,
                                    analyst: str = "", description: str = "") -> ForensicSession:
    ...
    async def analyze_with_plugins(self, branch_id: str, session_type: SessionType) -> Dict[str, str]:
    ...
    async def export_branch(self, branch_id: str, format: str = "json") -> Dict[str, str]:
        """
