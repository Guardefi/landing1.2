...
class SnapshotManager:
    ...
    def _generate_snapshot_id(self, branch_id: str, block_number: int, 
    ...
    async def create_snapshot(
        ...
        if self.deduplication_enabled:
            ...
            if existing_snapshot:
                logger.info(f"Deduplicating snapshot {snapshot_id} -> {existing_snapshot}")
        ...
        try:
            ...
            logger.info(f"Created snapshot {snapshot_id} (size: {metadata['size_bytes']} bytes)")
            return snapshot_id
    ...
    async def create_incremental_snapshot(self, branch_id: str, block_number: int,
                                        current_state: Dict[str, Any],
                                        parent_snapshot_id: str) -> str:
        ...
        return await self.create_snapshot(
            branch_id, block_number, incremental_state,
            incremental=True, parent_snapshot_id=parent_snapshot_id
        )
