...
class DatabaseConfig:
    ...
    url: str = field(default_factory=lambda: os.getenv("DATABASE_URL", "sqlite:///./time_machine.db"))
...
class BlockchainConfig:
    ...
    polygon_rpc_url: str = field(default_factory=lambda: os.getenv("POLYGON_RPC_URL", ""))
    ...
    polygonscan_api_key: str = field(default_factory=lambda: os.getenv("POLYGONSCAN_API_KEY", ""))
    bscscan_api_key: str = field(default_factory=lambda: os.getenv("BSCSCAN_API_KEY", ""))
...
class ServerConfig:
    ...
    reload: bool = field(default_factory=lambda: os.getenv("APP_ENV", "development") == "development")
...
class LoggingConfig:
    ...
    log_file: str = field(default_factory=lambda: os.getenv("LOG_FILE", "logs/time_machine.log"))
    error_log_file: str = field(default_factory=lambda: os.getenv("ERROR_LOG_FILE", "logs/time_machine.error.log"))
    max_file_size: str = field(default_factory=lambda: os.getenv("LOG_MAX_FILE_SIZE", "10MB"))
    backup_count: int = field(default_factory=lambda: int(os.getenv("LOG_BACKUP_COUNT", "5")))

@dataclass
class StorageConfig:
    """Storage configuration settings"""
    storage_path: str = field(default_factory=lambda: os.getenv("STORAGE_PATH", "./store"))
    snapshots_path: str = field(default_factory=lambda: os.getenv("SNAPSHOTS_PATH", "./store/snapshots"))
    bundles_path: str = field(default_factory=lambda: os.getenv("BUNDLES_PATH", "./store/bundles"))
    max_snapshot_size: str = field(default_factory=lambda: os.getenv("MAX_SNAPSHOT_SIZE", "100MB"))
...
class FeatureFlags:
    ...
    enable_demo_data: bool = field(default_factory=lambda: os.getenv("ENABLE_DEMO_DATA", "true").lower() == "true")
    enable_real_time_monitoring: bool = field(default_factory=lambda: os.getenv("ENABLE_REAL_TIME_MONITORING", "true").lower() == "true")
    enable_gas_optimization: bool = field(default_factory=lambda: os.getenv("ENABLE_GAS_OPTIMIZATION", "true").lower() == "true")
    enable_security_scanning: bool = field(default_factory=lambda: os.getenv("ENABLE_SECURITY_SCANNING", "true").lower() == "true")
...
class TimeMachineConfig:
    ...
    def _validate_config(self):
        ...
        if self.features.enable_real_time_monitoring and not self.blockchain.eth_rpc_url:
            raise ValueError("ETH_RPC_URL is required when real-time monitoring is enabled")
