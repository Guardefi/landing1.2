...
def get_engine() -> ScorpiusEngine:
    ...
    if _scorpius_engine is None:
        raise ScorpiusError("Scorpius not initialized. Call initialize_scorpius() first.")
    return _scorpius_engine

# Convenience exports
from .quantum import QuantumAlgorithm, SecurityLevel, QuantumKey
from .security import ThreatLevel, SecurityAlert
