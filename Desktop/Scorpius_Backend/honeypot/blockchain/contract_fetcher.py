...
class ContractFetcher:
    ...
    async def fetch_contract_details(self, address: str, chain_id: int = 1) -> Dict[str, Any]:
        """
    ...
    async def _fetch_abi_and_source(self, address: str, chain_id: int) -> Dict[str, Any]:
    ...
    async def _fetch_transactions(self, address: str, chain_id: int, limit: int = 50) -> List[Dict[str, Any]]:
    ...
    async def _fetch_token_metadata(self, address: str, chain_id: int) -> Optional[Dict[str, Any]]:
