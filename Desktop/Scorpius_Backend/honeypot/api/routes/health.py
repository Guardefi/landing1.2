...
async def system_status() -> Dict[str, Any]:
    ...
    if current_time - health_cache["last_check"] < health_cache["cache_ttl"] and health_cache["status"]:
...
async def readiness_probe(response: Response) -> Dict[str, str]:
    ...
    try:
        ...
        return {
            "status": "not ready", 
            "message": "Essential services unavailable"
        }
...
async def metrics_summary() -> Dict[str, Any]:
    ...
    from api.metrics import SYSTEM_INFO, DB_CONNECTION_STATUS
