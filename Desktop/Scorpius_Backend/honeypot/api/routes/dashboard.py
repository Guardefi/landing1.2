...
from models.data_models import RiskLevel, HoneypotTechnique
...
async def get_dashboard_stats(
    ...
    try:
        ...
        detection_rate = (honeypots_detected / total_analyses * 100) if total_analyses > 0 else 0
...
async def search_contracts(
    ...
    try:
        ...
        cursor = analyses_collection.find(search_filter)\
            .sort("analysis_timestamp", -1)\
            .skip(offset)\
            .limit(limit)
