...
class ValidatorStatusResponse:
    ...
    def __init__(self, validator: ValidatorInfo, last_seen: str, performance_metrics: dict):
...
class ValidatorServicer:
    ...
    async def ListValidators(self, request: ValidatorListRequest, context: grpc.aio.ServicerContext) -> ValidatorListResponse:
    ...
    async def GetValidatorStatus(self, request: ValidatorStatusRequest, context: grpc.aio.ServicerContext) -> ValidatorStatusResponse:
    ...
    async def StreamValidatorEvents(
        ...
        try:
            ...
            events = [
                ...
                ("validation_completed", {"transaction_id": "tx_123", "result": "success"}),
