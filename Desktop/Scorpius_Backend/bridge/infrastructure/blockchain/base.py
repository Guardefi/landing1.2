...
class BlockchainClient(ABC):
    ...
    @abstractmethod
    async def is_transaction_confirmed(self, tx_hash: str, required_confirmations: int) -> bool:
...
class BlockchainClientFactory:
    ...
    @classmethod
    def create_client(cls, chain_name: str, rpc_url: str, chain_id: int, **kwargs) -> BlockchainClient:
