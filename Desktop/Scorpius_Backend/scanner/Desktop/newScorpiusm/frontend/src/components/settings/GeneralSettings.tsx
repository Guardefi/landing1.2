...
export function GeneralSettings() {
  const { settings, updateSetting, resetSettings, exportSettings, importSettings } =
    useSettings();
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">{formatTime(settings.refreshInterval)}</Badge>
            </div>
            <Slider
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked => updateSetting('betaAccess', checked)}
              />
            </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action will reset all settings to their default values, including
                  API keys, RPC URLs, and preferences. This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
        ...
        <CardContent className="pt-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1">
              <h5 className="font-medium text-blue-900">Settings Information</h5>
              <p className="text-sm text-blue-700">
                Settings are automatically saved and encrypted locally. Last updated:{' '}
