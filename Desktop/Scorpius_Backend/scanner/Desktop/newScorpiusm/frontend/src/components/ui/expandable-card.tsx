          ...
          >
            ...
            >
              ...
              <div className="p-8">
                ...
                <motion.div layoutId={`preview-${id}`} style={{ display: 'none' }}>
                  {preview}
                </motion.div>
  ...
  const exampleItems: ExpandableCardProps[] = [
        ...
        <div className="space-y-6">
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
            ...
            <p className="text-gray-300">
              ...
              contract's withdraw function. This vulnerability could allow attackers to
          ...
          <div>
            ...
            <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm">
              ...
              <div className="ml-4">msg.sender.call{'{value: amount}'}("");</div>
    ...
    },
    {
      ...
      preview: (
        <div className="text-sm text-gray-300">
          <p>
            Comprehensive security analysis finished. 47 checks passed, 3 warnings
            found.
          </p>
          <div className="mt-3 flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-400 rounded-full mr-2" />
              <span className="text-xs text-green-400">High Security Score</span>
            </div>
    ...
    },
    {
      ...
      preview: (
        <div className="text-sm text-gray-300">
          <p>
            Potential honeypot contract detected. Multiple failed transactions observed.
          </p>
          <div className="mt-2 flex items-center text-xs text-gray-500">
      ...
      children: (
        <div className="space-y-6">
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-yellow-400 font-semibold mb-2">🍯 Honeypot Analysis</h3>
            <p className="text-gray-300">
              This contract exhibits patterns consistent with honeypot behavior. Users
              can buy tokens but cannot sell them due to hidden restrictions.
            </p>
          </div>
