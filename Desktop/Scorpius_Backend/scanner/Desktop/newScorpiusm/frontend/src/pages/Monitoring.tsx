                    ...
                    >
                        ...
                        <motion.div
                          ...
                          style={{
                            background: `linear-gradient(135deg, ${getStatusColor(
                              service.status,
                            )}20, ${getStatusColor(service.status)}40)`,
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm font-mono">
                        ...
                        <div>
                          ...
                          <div className="text-white font-bold">{service.requests}</div>
                        </div>
                        <div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <div className="flex justify-between text-xs mb-1">
                            ...
                            <span
                              className={`font-mono font-bold ${getUsageColor(
                                service.cpu,
                              )}`}
                            >
                              {service.cpu}%
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          <motion.div
                            ...
                            style={{
                              background: `linear-gradient(135deg, ${getStatusColor(
                                component.status,
                              )}20, ${getStatusColor(component.status)}40)`,
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm font-mono">
                        ...
                        <div>
                          ...
                          <div className={`font-bold ${getUsageColor(component.cpu)}`}>
                            {component.cpu}%
                          </div>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className="w-full bg-[#1a1a1a] rounded-full h-1.5">
                            <motion.div
                              ...
                              style={{
                                width: `${component.cpu}%`,
                                background: `linear-gradient(90deg, ${getUsageColor(
                                  component.cpu,
                                )}, ${getUsageColor(component.cpu)}aa)`,
                          ...
                          <div className="w-full bg-[#1a1a1a] rounded-full h-1.5">
                            <motion.div
                              ...
                              style={{
                                ...
                                background: `linear-gradient(90deg, ${getUsageColor(
                                  component.memory,
                                )}, ${getUsageColor(component.memory)}aa)`,
                                boxShadow: `0 0 6px ${getUsageColor(
                                  component.memory,
                                )}60`,
                              }}
                              initial={{ width: 0 }}
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-start gap-3">
                        <motion.div
                          className="mt-1"
                          animate={
                            alert.severity === 'Critical' ? { scale: [1, 1.2, 1] } : {}
                          }
                          transition={{ duration: 2, repeat: Infinity }}
                        >
                          <AlertTriangle
                    ...
                    {alert.status === 'Active' && (
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() => addNotification('Alert acknowledged', 'info')}
                        >
                        ...
                        <Button
                          ...
                          onClick={() => addNotification('Alert resolved', 'success')}
                        >
