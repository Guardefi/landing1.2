...
async def start_scan(request: ScanRequest):
    ...
    try:
        ...
        asyncio.create_task(run_mythril_scan(scan_id, request.target_path, request.options))
    ...
    try:
        ...
        if process.returncode == 0 or stdout:
            ...
            try:
                ...
                logger.info(f"Mythril scan {scan_id} completed with {len(findings)} findings")
            ...
            logger.error(f"Mythril scan {scan_id} failed with return code {process.returncode}")
