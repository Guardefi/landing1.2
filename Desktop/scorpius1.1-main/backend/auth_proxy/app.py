...
class LicenseVerifyResponse(BaseModel):
    """Response body for license verification."""
...
@app.post("/auth/license/verify", response_model=LicenseVerifyResponse)
async def verify_license(request: LicenseVerifyRequest):
    """Verify enterprise license key."""
    is_valid = await license_manager.validate_license(request.license_key)
    info = license_manager.get_license_info() if is_valid else None
    return LicenseVerifyResponse(valid=is_valid, info=info)
